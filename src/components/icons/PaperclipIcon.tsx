...
export default function PaperclipIcon({className}: Props) {
    return (
        <svg className={`text-primary object-contain ${className}`} fill="#000000" height="800px" width="800px"
             version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
             xmlnsXlink="http://www.w3.org/1999/xlink"
             viewBox="0 0 30.34 30.34" xmlSpace="preserve">
