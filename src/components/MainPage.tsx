...
export default function MainPage({ user }: Props) {
    ...
    return (
        <div className="overflow-x-clip overflow-y-hidden flex w-screen h-screen bg-neutral-800 text-white">
            <motion.div
                key="slider-modal"
            ...
            >
                { selectedChatroomId != '' ? (
                    <div className={`w-full md:ml-auto overflow-y-scroll scrollbar `}>
                        <ChatScreen
                            user={user}
